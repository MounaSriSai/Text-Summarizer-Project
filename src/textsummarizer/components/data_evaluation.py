...
class ModelEvaluation:
    ...
    def run(self):
        ...
        logger.info(f"Evaluating on validation dataset with {len(validation_dataset)} samples")

        score = self.calculate_metrics(validation_dataset, rouge_metric, model, tokenizer,
                                       batch_size=32, column_text='dialogue', column_summary='summary')
